...
if(zahl.value.trim() === ""){
    errorMessages.style.display = "block";
    errorMessages.textContent = "Please enter a number!";
    return;
}
...
return `         <p class="rechenSchrittText"><b>Step 1: Convert to decimal</b></p>
        ${rechenwegZuDezimalKomma(inputZahl, basisAusg)}         <p class="rechenSchrittText"><b>Step 2: Convert to base ${basisZiel}</b></p>
